...
export const translations = {
  fr: {
    ...
    about: {
      ...
      imageAlt: 'Vue de LAOM et de la vie collective',
      highlight: 'On y croise des danseurs, des permaculteurs, des hackers écolos, des thérapeutes, des makers, des coachs...',
      features: {
    ...
    events: {
      ...
      items: [
        {
          title: 'Danse & Silence #2',
          date: '25 févr. 2026 – 28 févr. 2026',
          description: 'Retraite immersive, mouvement et présence.',
        },
        {
          title: 'Rencontre Perspective #4',
          date: '5 mars 2026 – 8 mars 2026',
          description: 'Exploration collective, créativité et échanges.',
        },
        {
          title: 'Désirs d\'Aventure',
          date: '30 avr. 2026 – 3 mai 2026',
          description: 'Nature, exploration et élans créatifs.',
        },
        {
          title: 'Rencontre Fyneo #1',
          date: '11 juin 2026 – 13 juin 2026',
          description: 'Temps de rencontre et de création partagé.',
        },
      ],
    },
    trust: {
      title: 'Ils nous font confiance',
      logos: ['CSC', 'Vanlifest', 'LAOM'],
    },
    testimonials: {
      title: 'Ce qu’ils disent de LAOM Coliving',
      subtitle: 'Un témoignage en immersion.',
      caption: 'Témoignage retraite danse.',
    },
    contact: {
      title: 'Contact',
    ...
    pages: {
      ...
      school: {
        ...
        heroSubtitle: 'De l\'idée à la réalité : créez votre éco-coliving.',
        problemTitle: 'Pourquoi la majorité des projets échouent',
        problems: [
          'Complexité administrative sous-estimée',
          'Structure juridique mal préparée',
        ...
        program: [
          ...
          'Structures juridiques (focus SCIA)',
          'Permis, STECAL, PLUI',
      ...
      resources: {
        ...
        items: [
          {
            title: 'Newsletter',
            description: 'Coulisses du projet, décisions clés, apprentissages.',
          },
          {
            title: 'YouTube',
  ...
  en: {
    ...
    about: {
      ...
      imageAlt: 'View of LAOM and community life',
      highlight: 'We meet dancers, permaculturists, eco hackers, therapists, makers, coaches...',
      features: {
    ...
    events: {
      ...
      items: [
        {
          title: 'Dance & Silence #2',
          date: 'Feb 25, 2026 – Feb 28, 2026',
          description: 'Immersive retreat, movement and presence.',
        },
        {
          title: 'Perspective Meeting #4',
          date: 'Mar 5, 2026 – Mar 8, 2026',
          description: 'Collective exploration, creativity and exchange.',
        },
        {
          title: 'Adventure Desires',
          date: 'Apr 30, 2026 – May 3, 2026',
          description: 'Nature, exploration and creative momentum.',
        },
        {
          title: 'Fyneo Gathering #1',
          date: 'Jun 11, 2026 – Jun 13, 2026',
          description: 'Shared time for connection and creation.',
        },
      ],
    },
    trust: {
    ...
    testimonials: {
      title: 'What they say about LAOM Coliving',
      subtitle: 'An immersive testimonial.',
      caption: 'Dance retreat testimonial.',
    },
    contact: {
      title: 'Contact',
    ...
    pages: {
      ...
      school: {
        heroTitle: 'LAOM School',
        heroSubtitle: 'From idea to reality: build your eco-coliving.',
        problemTitle: 'Why most projects fail',
        problems: [
          'Administrative complexity underestimated',
          'Legal structure not prepared',
          'Financing poorly anticipated',
      ...
      resources: {
        ...
        items: [
          {
            title: 'Newsletter',
            description: 'Behind the scenes, key decisions, lessons learned.',
          },
          {
            title: 'YouTube',
      ...
      newsletterPage: {
        heroTitle: 'LAOM Letter',
        heroSubtitle: 'Behind the scenes, key decisions, news and events. No spam.',
